...
Alternatively, on some devices users may log into the PZH web interface
...
The following messages are exchanged between PZP and PZH. We do not show
...
### PZPs[¶](#PZPs)
  ...
  Application                          Applications don't authenticate
                                       devices.
