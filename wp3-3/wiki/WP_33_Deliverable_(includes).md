...
![](/redmine/attachments/download/1601)
...
![](/redmine/attachments/download/1602)
...
![](/redmine/attachments/download/1604)
...
![](/redmine/attachments/download/1606)
...
![](/redmine/attachments/download/1605)
...
![](/redmine/attachments/download/1608)
...
bootstrap](/redmine/projects/wp3-3/wiki/PZP_installation_bootstrap),
...
Architecture](/redmine/projects/wp3-3/wiki/Spec_-_Authentication#Conceptual-Architecture)
...
[Spec\_-\_Synchronisation](/redmine/projects/wp3-3/wiki/Spec_-_Synchronisation)
...
![](/redmine/attachments/download/1610)
...
![](/redmine/attachments/download/1611)
...
![](/redmine/attachments/download/1612)
...
[D3.5](/redmine/projects/wp3-3/wiki/Spec_-_Authentication#Webinos-D35)
...
architectural
components](/redmine/projects/wp3-3/wiki/Webinos_key_architectural_components)
...
the policy defintion[TBD](/redmine/projects/wp3-3/wiki/TBD)
...
found in the
[Background](/redmine/projects/wp3-3/wiki/Background_-_Discovery) and
[Specification](/redmine/projects/wp3-3/wiki/Spec_-_Discovery#Discovery-of-Personal-Zone-Hub)
...
in deliverable
[D3.2](/redmine/projects/wp3-3/wiki/Spec_-_Authentication#Webinos-D32)
in the [JavaScript
APIs](http://dev.webinos.org/specifications/draft/authentication.html)
section.
...
Levels](/redmine/projects/wp3-3/wiki/Spec_-_Authentication#User-Authentication-levels)
...
[Synchronisation](/redmine/projects/wp3-3/wiki/Spec_-_Synchronisation)
section.
...
([COHEN11](/redmine/projects/wp3-3/wiki/Spec_-_Discovery#-COHEN11)). In
...
![](/redmine/attachments/download/1613)
...
![](/redmine/attachments/download/1614)
...
([OASISXACML](/redmine/projects/wp3-3/wiki/Spec_-_Security#OASISXACML)).
...
([PRIMELIFE](/redmine/projects/wp3-3/wiki/Spec_-_Security#PRIMELIFE))
...
deliverable ([D035](/redmine/projects/wp3-3/wiki/Spec_-_Security#D035))
...
([BONDIA&S](/redmine/projects/wp3-3/wiki/Spec_-_Security#BONDIAxxS))
following the grammar provided by WAC
([WACXMLSP](/redmine/projects/wp3-3/wiki/Spec_-_Security#WACXMLSP)).
This format has been used as a basis in different specifications as W3C
DAP ([DAPWG](/redmine/projects/wp3-3/wiki/Spec_-_Security#DAPWG)) and
WAC ([WACDS](/redmine/projects/wp3-3/wiki/Spec_-_Security#WACDS)).\
...
-   The policy is user-dependent, but default policies could be defined
    ...
    ([User-Info](/redmine/projects/wp3-3/wiki/Spec_-_Security#User-Info))).
...
([BONDIA&S](/redmine/projects/wp3-3/wiki/Spec_-_Security#BONDIAxxS)) and
...
background](/redmine/projects/wp3-3/wiki/Extensions_background) section
...
([BONDIA&S](/redmine/projects/wp3-3/wiki/Spec_-_Security#BONDIAxxS)):
  ...
  **Attribute**   **Type**   **Value**
  service         URI        URI that identifies the service
  app-extension   URI        URI that identifies the extension. If for the extension is not defined an URI, this will be composed by the application URI followed by the name of the extension (using percent-encoding for special characters [RFC3986](/redmine/projects/wp3-3/wiki/Spec_-_Security#RFC3986) ) eg. the URI for the extension named "Extension 1" from the manifest of "Application A" which URI is "http://www.ApplicationA.com" will be "http://www.ApplicationA.com/Extension%201"
  --------------- ---------- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
([D022](/redmine/projects/wp3-3/wiki/Spec_-_Security#D022))
...
![](/redmine/attachments/download/1615)\
...
See [Installable Web
Application](/redmine/projects/wp3-3/wiki/Glossary#Installable-Web-Application)
...
-   service discovery\
     See [Service
    Discovery](/redmine/projects/wp3-3/wiki/Glossary#Service-Discovery)
...
See [Digital
identity](/redmine/projects/wp3-3/wiki/Glossary#Digital-identity)
...
([Sources](/redmine/projects/wp3-3/wiki/Glossary#Sources))
...
An [extension](/redmine/projects/wp3-3/wiki/Glossary#Extension) that, if
not available, still allows the application to run, yet with less and/or
degraded functionality.

### Optional feature[¶](#Optional-feature)

A [feature](/redmine/projects/wp3-3/wiki/Glossary#Feature) that, if not
...
See [Extension](/redmine/projects/wp3-3/wiki/Glossary#Extension)
...
can loop back to the
[PIP](/redmine/projects/wp3-3/wiki/Glossary#Glossary%23Policy-Information-Point-PIP)
for more information as the policies are executed.
...
A [feature](/redmine/projects/wp3-3/wiki/Glossary#Feature) that is
...
### Symmetrised Hash Commitment Before Knowledge (SHCBK) protocol[¶](#Symmetrised-Hash-Commitment-Before-Knowledge-SHCBK-protocol)
...
#### Synchronization - Media run time synchronization[¶](#Synchronization-Media-run-time-synchronization)
